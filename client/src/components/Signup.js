                    ...
                    <div className="row mx-2">
                        ...
                        <form>
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" id="phone" aria-describedby="emailHelp" autoComplete="off"/>
                            </div>
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" id="profession" aria-describedby="emailHelp" autoComplete="off"/>
                            </div>
                            <div className="mb-3">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="password" className="form-control" id="confirm-password" autoComplete="off"/>
                            </div>
